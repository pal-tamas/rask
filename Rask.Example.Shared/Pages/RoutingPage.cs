...
[Route("routing"), ParentRoute(typeof(ShowcaseLayout))]
        ...
        Fragment(
            ...
            Components.CodeSample(
                Source: """
                    ...
                    """,
                Notes: "Routes use Blazor-style {param} placeholders. Optional, catch-all (**rest), and type-constrained variants are all supported."),
            ...
            Components.CodeSample(
                Source: """
                    ...
                    """,
                Notes: "Child templates are joined to the parent's. An empty child template (\"\") means \"default child for this layout\". This very showcase is built that way — every page declares [ParentRoute(typeof(ShowcaseLayout))]."),
            ...
            [
                ...
                Button(
                    Class: "btn btn-outline-primary btn-sm",
                    OnClick: () => nav.Navigate("/users/ada", new[] { KeyValuePair.Create<string, string?>("tab", "profile") }),
