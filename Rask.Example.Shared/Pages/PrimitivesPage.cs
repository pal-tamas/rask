...
[Route("primitives"), ParentRoute(typeof(ShowcaseLayout))]
        ...
        Fragment(
            ...
            Components.CodeSample(
                Source: """
                    ...
                    P(Children: ["1 < 2 && \"safe\""])
                    """,
                Notes: "Text HTML-encodes its value. The < and & above render as literal characters, not parsed as markup.",
            ...
            Components.CodeSample(
                Source: """
                    ...
                    """,
                Notes: "Raw is the escape hatch. Use when you control the source (markdown output, sanitized snippets); never on user input.",
            ...
            [
                ...
                [
                    ...
                    " ", Code(Children: ["Raw"]), " skips all HTML encoding. Never feed it untrusted strings — sanitize or use ",
            ...
            Components.CodeSample(
                Source: """
                    ...
                    """,
                Notes: "Fragment renders its children with no surrounding tag — handy for siblings at the root, especially Fragment(Doctype(), Html(...)) as the page entry.",
                Result: Fragment(
            ...
            Components.CodeSample(
                Source: """
                    ...
                    """,
                Notes: "Doctype() emits exactly <!DOCTYPE html>. Special-cased — no attributes, no children, no wrapping tag.",
