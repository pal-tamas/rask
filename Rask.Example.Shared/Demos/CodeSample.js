...
// by HtmlSerializer) when CodeSample.cs's OnRendered calls InvokeJs("rendered", …).
// The hljs <link> + <script> dependencies are declared by CodeSample.Head and the
// framework auto-emits them inside <head>; by the time rendered runs the
// highlighter is either ready (synchronous script in head) or about to be — we
