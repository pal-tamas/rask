...
/// <remarks>
///     <para>
///         Named <c>TypeScriptSlot</c> rather than <c>Slot</c> because <c>Slot</c> is already the HTML
...
///         emits them into a slot template; an <c>TypeScriptSlot</c> outside an island renders nothing,
...
///     </example>
/// </remarks>
public sealed partial class TypeScriptSlot : Component
{
    /// <summary>
