...
/// </remarks>
[RaskMarkup]
public static partial class TypeScriptSlots
{
    ...
    public static IEnumerable<Component?> Wrap(IEnumerable<Component?>? children)
    {
        ...
        foreach (var child in children)
        {
            ...
            if (child is TypeScriptSlot slot)
            {
                named ??= [];
        ...
        {
            yield return TypeScriptSlotTemplate.SlotName(DefaultSlot)[unassigned];
        }
        ...
        {
            yield return TypeScriptSlotTemplate.SlotName(name)[content];
        }
    }
}
...
/// </remarks>
internal sealed partial class TypeScriptSlotTemplate : Component
{
    /// <summary>The slot name, as the front-end component knows it.</summary>
    public string SlotName { get; set; } = TypeScriptSlots.DefaultSlot;
    ...
    protected override void WriteAttributes(StringBuilder sb) =>
        ...
        // see a slot at all.
        AppendAttr(sb, TypeScriptSlots.SlotAttribute, SlotName);
}
