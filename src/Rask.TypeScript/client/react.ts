// rask-ts React adapter, vendored from Rask.TypeScript.
//
...
import type { TypeScriptAdapter, TypeScriptProps, TypeScriptSlots } from './adapter'
 ...
 */
export function reactComponent<P extends object>(Component: ComponentType<P>): TypeScriptAdapter<Root> {
  ...
  const render = (root: Root, props: TypeScriptProps) =>
 ...
 */
function adopt(slots: TypeScriptSlots): Record<string, ReactElement> {
