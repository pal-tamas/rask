...
/// </remarks>
[RaskMarkup]
public static partial class ExternalSlots
{
    ...
    public static IEnumerable<Component?> Wrap(IEnumerable<Component?>? children)
    {
        ...
        {
            yield return ExternalSlotTemplate.SlotName(DefaultSlot)[unassigned];
        }
        ...
        {
            yield return ExternalSlotTemplate.SlotName(name)[content];
        }
    }
}
...
/// </remarks>
internal sealed partial class ExternalSlotTemplate : Component
{
    /// <summary>The slot name, as the front-end component knows it.</summary>
    public string SlotName { get; set; } = ExternalSlots.DefaultSlot;
    ...
    protected override void WriteAttributes(StringBuilder sb) =>
        ...
        // see a slot at all.
        AppendAttr(sb, ExternalSlots.SlotAttribute, SlotName);
}
