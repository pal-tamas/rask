...
/// <summary>
///     A counter rendered by <c>AngularCounter.ts</c> — an ordinary Angular component used as an
...
///     <c>@rask/AngularCounter.props</c>, so renaming one stops the front-end file compiling — the contract is
///     checked in both directions rather than maintained by discipline.
/// </remarks>
public sealed partial class AngularCounter : Rask.External.AngularComponent
{
