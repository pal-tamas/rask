...
/// <summary>
///     A counter rendered by <c>SvelteCounter.svelte</c> — an ordinary Svelte component used as an
...
///     <c>@rask/SvelteCounter.props</c>, so renaming one stops the front-end file compiling — the contract is
///     checked in both directions rather than maintained by discipline.
/// </remarks>
public sealed partial class SvelteCounter : Rask.External.SvelteComponent
{
