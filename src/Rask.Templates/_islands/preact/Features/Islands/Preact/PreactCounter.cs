...
/// <summary>
///     A counter rendered by <c>PreactCounter.tsx</c> — an ordinary Preact component used as an
...
///     <c>@rask/PreactCounter.props</c>, so renaming one stops the front-end file compiling — the contract is
///     checked in both directions rather than maintained by discipline.
/// </remarks>
public sealed partial class PreactCounter : Rask.External.PreactComponent
{
