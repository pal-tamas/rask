...
/// <summary>
///     A counter rendered by <c>ReactCounter.tsx</c> — an ordinary React component used as an
...
///     <c>@rask/ReactCounter.props</c>, so renaming one stops the front-end file compiling — the contract is
