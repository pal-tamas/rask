...
/// <summary>
///     A counter rendered by <c>LitBadge.ts</c> — an ordinary Lit component used as an
...
///     <c>@rask/LitBadge.props</c>, so renaming one stops the front-end file compiling — the contract is
