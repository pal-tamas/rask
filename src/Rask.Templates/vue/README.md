...
A Vue front end on an ASP.NET host, talking to it over Rask's CQRS wire.
...
| `Company.RaskServer/client/` | The Vue app, as `create-vite` scaffolds it, plus four files Rask overlays. |
