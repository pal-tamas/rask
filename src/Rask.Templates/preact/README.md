...
A Preact front end on an ASP.NET host, talking to it over Rask's CQRS wire.
...
| `Company.RaskServer/client/` | The Preact app, as `create-vite` scaffolds it, plus four files Rask overlays. |
