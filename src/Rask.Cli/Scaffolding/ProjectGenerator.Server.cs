...
internal static partial class ProjectGenerator
{
    ...
    private static string ServerNextSteps(string name, ServerBatteries batteries)
    {
        ...
        if (batteries.Data)
        {
            ...
            steps.Append("itself — Product.Where(...), Product.FindAsync(id) — and save a change from a\n");
            steps.Append("CQRS handler: inject AppDbContext, call the entity's method, SaveChangesAsync.\n");
        }
