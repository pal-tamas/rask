...
public static class Current
{
    ...
    ///         <see cref="UserId" /> is null for it.
    ///     </para>
    ///     <para>
    ///         <see cref="UseUser" /> does not change this. A job run for a user has that user's id and no
    ...
    /// </summary>
    /// <remarks>
    ///     An explicit <see cref="UseUser" /> first — a background job runs for the user its row recorded,
    ...
    /// <exception cref="InvalidOperationException">No user is signed in and no <see cref="UseUser" /> scope is open.</exception>
    ...
    ///     somebody in. It wins over the signed-in principal, and it changes <see cref="UserId" /> only —
    ///     never <see cref="Principal" />.
    /// </remarks>
