// rask-islands adapter contract, vendored from Rask.Islands.
//
// Everything Rask needs from React, Lit, Vue, Svelte or Angular fits in three functions. That is what
// makes the second and third runtimes cheap once the first exists — and why rask-islands.js imports
 ...
 */
export type IslandSlots = Record<string, DocumentFragment>
 ...
 */
export interface IslandAdapter<THandle = unknown> {
  /**
   ...
   */
  mount(element: Element, props: IslandProps, slots?: IslandSlots): THandle
   ...
   */
  update?(handle: THandle, props: IslandProps): THandle | void
