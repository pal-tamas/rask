...
/// <remarks>
///     <para>
///         Named <c>IslandSlot</c> rather than <c>Slot</c> because <c>Slot</c> is already the HTML
...
///         emits them into a slot template; an <c>IslandSlot</c> outside an island renders nothing,
...
///     </example>
/// </remarks>
public sealed partial class IslandSlot : Component
{
    /// <summary>
