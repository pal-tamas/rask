// rask-islands.js — the browser half of Rask.Islands.
//
...
const HOST_TAG = "RASK-ISLAND";
const MANIFEST_URL = "/_rask/islands/manifest.json";
 ...
 */
function resolver() {
    return (globalThis.__raskIslands && globalThis.__raskIslands.resolve) || defaultResolve;
}
...
if (typeof document !== "undefined" && !globalThis.__raskIslandsManual) {
    start();
}
