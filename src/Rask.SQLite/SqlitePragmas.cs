...
/// connection. This is the single source of truth shared by the Entity Framework Core interceptor
/// (<see cref="RaskSqliteConnectionInterceptor"/>) and the raw-ADO factory
/// (<see cref="IRaskSqliteConnectionFactory"/>).
/// </summary>
