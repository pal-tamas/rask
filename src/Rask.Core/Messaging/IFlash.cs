...
///     <para>
///         Producers inject <see cref="IFlash" /> and call <see cref="Success" /> / <see cref="Error" />
///         / … (or <see cref="Add" />). A single <c>FlashOutlet</c> mounted in the app layout subscribes
...
public interface IFlash
{
    ...
    void Add(FlashLevel level, string message, string? title = null);

    /// <summary>Queue an <see cref="FlashLevel.Info" /> message.</summary>
    void Info(string message, string? title = null) => Add(FlashLevel.Info, message, title);

    /// <summary>Queue a <see cref="FlashLevel.Success" /> message.</summary>
    void Success(string message, string? title = null) => Add(FlashLevel.Success, message, title);

    /// <summary>Queue a <see cref="FlashLevel.Warning" /> message.</summary>
    void Warning(string message, string? title = null) => Add(FlashLevel.Warning, message, title);

    /// <summary>Queue an <see cref="FlashLevel.Error" /> message.</summary>
    void Error(string message, string? title = null) => Add(FlashLevel.Error, message, title);
    ...
    /// </summary>
    IReadOnlyList<FlashMessage> Consume();
}
