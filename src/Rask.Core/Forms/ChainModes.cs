...
//
// Abstract with no members rather than an enum or a bool: a type argument is the only thing an extension
// method can discriminate on, and abstract says the "value" was never the point.
