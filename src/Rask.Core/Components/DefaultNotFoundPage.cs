...
public sealed class DefaultNotFoundPage : Component
{
    ...
    protected override RenderResult Render()
    {
        ...
        return Generated.Div(
            ...
            Generated.H1(Style: "margin:0 0 0.75rem;font-size:2rem;")["Page not found"],
            Generated.P(Style: "margin:0 0 1.25rem;color:#4b5563;line-height:1.5;")[
                "No route is registered for ",
                Generated.Code(Style: "background:#f3f4f6;padding:0.1rem 0.35rem;border-radius:0.25rem;")[
                    path.Length == 0 ? "/" : path
                ],
                "."
            ],
