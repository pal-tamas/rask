...
/// <remarks>
///     <para>
///         <c>OnMount</c> is deliberately fire-and-forget: the render walk starts it, keeps
...
///         already gone — which is why a page that loads its data in <c>OnMount</c> serves its
