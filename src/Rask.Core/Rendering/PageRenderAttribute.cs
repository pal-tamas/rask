...
///     </para>
///     <para>
///         <see cref="PageRenderMode.Interactive" /> is honoured from <b>anywhere</b> in the page's
...
///     </para>
///     <para>
///         <see cref="PageRenderMode.Static" /> is honoured only on the page itself or the app root.
...
public sealed class PageRenderAttribute(PageRenderMode mode) : Attribute
{
    /// <summary>The declared mode.</summary>
    public PageRenderMode Mode { get; } = mode;
}
