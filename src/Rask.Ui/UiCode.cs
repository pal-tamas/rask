...
/// making the whole page scroll sideways. <see cref="Ui.Tone.Error" /> for anything that is the reason
/// something failed.
/// </remarks>
public sealed partial class UiCode : Component
{
    ...
    /// <summary><see cref="Ui.Tone.Error" /> to read it as a failure. Anything else is neutral machine output.</summary>
