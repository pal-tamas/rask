...
/// <summary>
///     Calls its own scoped TypeScript like private methods: <c>WindowSize()</c>, <c>NewCountdown(5)</c> and the
///     countdown's <c>Start</c>/<c>Stop</c> are generated from <c>ScriptCallsDemo.ts</c>.
/// </summary>
