        ...
        Section.Class(SectionPad)[
            Div.Class(Wrap)[
                ...
                Div.Class("grid gap-4 sm:grid-cols-2 lg:grid-cols-3")[
                    ...
                    Feature(UiIconName.Bolt, "Cache & query", "cache", "A database-backed ", Code["IDistributedCache"], ", a typed ", Code["ICache"], " with ", Code["Cache.Remember"], ", and ", Code["Rask.Query"], " wrapping the dispatcher with dedup, staleness and invalidation."),
