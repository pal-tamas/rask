...
/// <see cref="IQueryDispatcher.QueryAsync{TResult}"/>.
/// </summary>
...
/// <see cref="ICommandHandler{TCommand}"/>. Dispatch it through <see cref="ICommandDispatcher.SendAsync(ICommand, System.Threading.CancellationToken)"/>.
/// </summary>
...
/// <see cref="ICommandDispatcher.SendAsync{TResult}(ICommand{TResult}, System.Threading.CancellationToken)"/>.
/// </summary>
