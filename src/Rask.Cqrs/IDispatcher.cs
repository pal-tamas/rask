...
public interface IDispatcher
{
    ...
    IAsyncEnumerable<TNotification> Subscribe<TNotification>(CancellationToken cancellationToken = default)
        where TNotification : INotification;
    ...
    /// <param name="cancellationToken">Ends the subscription.</param>
    IAsyncEnumerable<TNotification> Subscribe<TNotification>(
