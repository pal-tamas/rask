...
public sealed class HeadChildrenAnalyzer : DiagnosticAnalyzer
{
    ...
    private static readonly DiagnosticDescriptor Rask019 = new(
        ...
        "Do not pass children to '<head>'; declare head content by overriding the 'protected Component? HeadAssets' property on any component instead. The framework collects, dedupes, and splices contributions automatically.",
