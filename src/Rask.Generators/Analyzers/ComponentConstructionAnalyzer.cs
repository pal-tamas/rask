...
public sealed class ComponentConstructionAnalyzer : DiagnosticAnalyzer
{
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        {
            // The rule is "construct components through the chain, not 'new'", and it exempts Rask.Core
            // because Rask.Core is what BUILDS that chain — a tag component assembling its own children
            // predates its own entry.
