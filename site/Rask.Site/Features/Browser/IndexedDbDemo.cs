        ...
        Div.Class($"{Tw.Card} shadow-sm border-0")[
            Div.Class(Tw.CardBody)[
                ...
                Div.Class("flex gap-2 flex-wrap items-center mb-2")[
                    UiButton.Tone(UiTone.Primary).Id("idb-set").OnClickAsync(Set)["Set"],
                    UiButton.Tone(UiTone.Primary).Variant(UiVariant.Outline).Id("idb-get").OnClickAsync(Get)["Get"],
                    UiButton.Tone(UiTone.Secondary).Variant(UiVariant.Outline).Id("idb-keys").OnClickAsync(Keys)["List keys"],
                    UiButton.Tone(UiTone.Error).Variant(UiVariant.Outline).Id("idb-clear").OnClickAsync(Clear)["Clear"]
                ],
