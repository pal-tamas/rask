...
public sealed partial class GanttTests : global::Rask.Core.RaskMarkup
{
    ...
    {
        var chart = new Rask.Site.Features.Gantt(new FakeJsRuntime()) { Data = Tasks };
    ...
    public void ViewMode_MapsToTheLibrarysOwnString(GanttViewMode mode, string expected) =>
        Assert.Equal(expected, Rask.Site.Features.Gantt.ToJsViewMode(mode));
    ...
    public void EveryViewMode_MapsToADistinctString()
    {
        var mapped = Enum.GetValues<GanttViewMode>()
            .Select(Rask.Site.Features.Gantt.ToJsViewMode)
            .ToArray();
    ...
    {
        var js = new FakeJsRuntime();
        var chart = new Rask.Site.Features.Gantt(js)
        {
            Data = Tasks,
    ...
    public async Task Interop_RoutesEachEventToTheOwningChart()
    {
        ...
        var moved = "";
        var progress = -1d;
        var chart = new Rask.Site.Features.Gantt(new FakeJsRuntime())
        {
            Data = Tasks,
