...
public sealed class ResourcesSpliceTests
{
    ...
    public void Resources_template_splices_to_committed_Browser_rask_wasm_js()
    {
        ...
        var scopedPath = Path.Combine(repoRoot, "Rask.Core", "Resources", "rask-scoped.js");
        ...
        Assert.True(
            ...
            "regenerates Browser/rask.wasm.js from the template + rask-scoped.js + rask-morph.js " +
