...
public sealed class ResourcesSpliceTests
{
    ...
    public void Resources_template_splices_to_committed_Browser_rask_wasm_js()
    {
        ...
        Assert.True(
            ...
            "regenerates Browser/rask.wasm.js from the template + Rask.Core/Resources/rask-morph.js " +
            "on every clean build; if those two diverge, CI ships a Browser/rask.wasm.js that " +
