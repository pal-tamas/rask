...
public sealed class Dialog : Component<Dialog.Props>
{
    public Dialog(Props? props, IEnumerable<Child>? children = null) : base(props, children) { }
    public Dialog(Props? props, params Child[] children) : base(props, children) { }
