...
public sealed class DefaultErrorPage : Component
{
    ...
    protected override Component Render()
    {
        ...
        {
            Components.H1(Style: "margin:0 0 0.75rem;font-size:1.5rem;color:#b42323;", Children: ["Something went wrong"]),
            Components.P(Style: "margin:0 0 0.5rem;color:#4b5563;font-family:ui-monospace,Menlo,Consolas,monospace;font-size:0.9rem;",
                Children: [typeName]),
            Components.Pre(
                Style:
