...
public sealed class DefaultNotFoundPage : Component
{
    ...
    protected override Component Render()
    {
        ...
        return Components.Div(
            ...
            Children:
            [
                Components.H1(Style: "margin:0 0 0.75rem;font-size:2rem;", Children: ["Page not found"]),
                Components.P(Style: "margin:0 0 1.25rem;color:#4b5563;line-height:1.5;", Children:
                [
                    "No route is registered for ",
                    Components.Code(Style: "background:#f3f4f6;padding:0.1rem 0.35rem;border-radius:0.25rem;", Children:
                    [
                        path.Length == 0 ? "/" : path
                    ]),
                    "."
