...
public class AudioTests
{
    ...
    public void Render_AllPropsSet_EmitsExpectedAttributes()
    {
            ...
            Audio(Src: "/a.mp3", Controls: true, Autoplay: true, Loop: true, Muted: true, Preload: "auto", CrossOrigin: "anonymous", Id: "i", Class: "c", Style: "s", Data: new Dictionary<string, string?> { ["k"] = "v" }).ToHtml());
    }
