...
public class ImgTests
{
    ...
    public void Render_AllPropsSet_EmitsExpectedAttributes()
    {
        ...
        Assert.Equal(
            ...
            Img(Src: "/a.png", Alt: "alt text", Width: 100, Height: 50, Loading: "lazy", Srcset: "/a.png 1x, /a@2x.png 2x", Sizes: "100vw", CrossOrigin: "anonymous", ReferrerPolicy: "no-referrer", Decoding: "async", UseMap: "#m", Ismap: true, Id: "i", Class: "c", Style: "s", Data: new Dictionary<string, string?> { ["k"] = "v" }).ToHtml());
    }
}
