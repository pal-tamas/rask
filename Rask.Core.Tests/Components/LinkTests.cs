...
public class LinkTests
{
    ...
    public void Render_AllPropsSet_EmitsExpectedAttributes()
    {
        ...
        Assert.Equal(
            ...
            new Link { Href = "/style.css", Rel = "stylesheet", Type = "text/css", Media = "all", Sizes = "16x16", Hreflang = "en", As = "style", CrossOrigin = "anonymous", ReferrerPolicy = "no-referrer", Disabled = true, Color = "#fff", Id = "i", Class = "c", Style = "s", Data = new Dictionary<string, string?> { ["k"] = "v" } }.ToHtml());
    }
}
