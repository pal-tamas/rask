# Rask diagnostics (RASK001–RASK046)
...
| [RASK046](#rask046) | Error | HTML nested inside a native screen |
...
classifies by the container. See [RASK046](#rask046) for the mirror-image mistake.
...
```csharp
// ✗ RASK046 — a Div inside a native screen renders nothing
