...
| [Live playground](playground.md) | Write Rask C# in the browser and see it compile & render live (Roslyn in WebAssembly) — how it works, the entry-point convention, and its limitations. |
