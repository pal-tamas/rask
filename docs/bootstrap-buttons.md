...
BsLink.Href("https://github.com/pal-tamas/rask").Target("_blank").Rel("noopener").Color(BsColor.Light).Outline(true)[BsIcon.Name(BsIconName.Github).Class("me-1"), "GitHub"]
```
