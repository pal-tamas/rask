...
creates none. EF Core in the browser needs the trimmer to leave it whole — its three assemblies rooted, while
Rask.Data and Rask.SQLite.EntityFrameworkCore are trim-safe and need nothing — see
[SQLite in the browser](sqlite.md#sqlite-in-the-browser-wasm) for the recipe.
