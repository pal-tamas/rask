...
- **New diagnostic** → `add-diagnostic` skill. Diagnostic IDs RASK001–091 are documented in `docs/diagnostics.md`
  (RASK027/030/032/034/042/046/047/048/049/050/054/081 are retired and never recycled; RASK063/065 are RESERVED for Rask.Blazor and unimplemented; the next free id is RASK092). **Grep `src/`
