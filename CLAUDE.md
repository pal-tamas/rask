...
(`docs/js-interop.md`, `docs/browser-apis.md` — the 45-wrapper map), forms +
validation (`docs/forms.md`), auth (`docs/authentication.md`), context/callbacks (`docs/composition.md`),
diagnostics RASK001–032 (`docs/diagnostics.md` — analyzer descriptors are the source of truth), getting
...
- **New diagnostic** → `add-diagnostic` skill. Diagnostic IDs RASK001–032 are documented in `docs/diagnostics.md`.
