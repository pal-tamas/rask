...
diagnostics RASK001–039 (`docs/diagnostics.md` — analyzer descriptors are the source of truth), getting
...
- **New diagnostic** → `add-diagnostic` skill. Diagnostic IDs RASK001–039 are documented in `docs/diagnostics.md`.
