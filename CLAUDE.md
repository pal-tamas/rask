...
- **New diagnostic** → `add-diagnostic` skill. Diagnostic IDs RASK001–060 are documented in `docs/diagnostics.md`
  (RASK030/032/034/042/047/048/049/050 are retired and never recycled; RASK062/063/065 are RESERVED for Rask.Blazor and unimplemented; the next free id is RASK067). **Grep `src/`
