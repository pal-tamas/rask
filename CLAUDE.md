...
diagnostics RASK001–089, RASK027/030/032/034/042/047/048–050/054/081 retired (`docs/diagnostics.md` — analyzer descriptors are the source of truth), getting
...
- **New diagnostic** → `add-diagnostic` skill. Diagnostic IDs RASK001–089 are documented in `docs/diagnostics.md`
  (RASK027/030/032/034/042/047/048/049/050/054/081 are retired and never recycled; RASK063/065 are RESERVED for Rask.Blazor and unimplemented; the next free id is RASK090). **Grep `src/`
