...
diagnostics RASK001–042 (`docs/diagnostics.md` — analyzer descriptors are the source of truth), getting
...
- **New diagnostic** → `add-diagnostic` skill. Diagnostic IDs RASK001–042 are documented in `docs/diagnostics.md`.
