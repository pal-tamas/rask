...
// App shell: the framework-managed <head> (one stylesheet, compiled from this project's own
// source by Rask.Tailwind), a sticky navbar, and a Router that renders the matched page.
    ...
    [
        Nav.Class("flex items-center border-b border-slate-800 bg-slate-900 text-slate-100 shadow-sm")[
            Div.Class("mx-auto w-full max-w-6xl px-4")[
                NavLink.Href(Features.Routes.HomePage()).Class("app-brand font-bold")["Rask · cookie auth"],
                A
