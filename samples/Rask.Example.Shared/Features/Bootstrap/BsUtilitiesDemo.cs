    ...
    [
        Div.Class(Bs.Join(Display.Flex(), Flex.Column(), Flex.Gap(4)))[
            ...
            Section("Rounded & Background", Div.Class(Bs.Join(Display.Flex(), Flex.Wrap(), Flex.Gap(2)))[
                Span
                    .Class(Bs.Join(Bg.Color(BsColor.Primary), Txt.Color(BsColor.Light), Rounded.Pill, Padding.X(3), Padding.Y(2)))["Rounded.Pill"],
                Span
                    .Class(Bs.Join(Bg.Color(BsColor.Success), Txt.Color(BsColor.Light), Rounded.Default, Padding.X(3), Padding.Y(2)))["Rounded.Default"],
                Span
                    .Class(Bs.Join(Bg.Color(BsColor.Dark), Txt.Color(BsColor.Light), Rounded.None, Padding.X(3), Padding.Y(2)))["Rounded.None"]
            ]),
            ...
            Section("Responsive (Bp)",
                Div
                    .Class(Bs.Join(Bg.BodyTertiary, Border.All, Rounded.Default, Padding.All(3),
