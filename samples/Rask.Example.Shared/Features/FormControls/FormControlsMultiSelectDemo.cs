...
//   • Bound — BsMultiSelect.Bind(() => model.X, options): two-way binds the model collection through the EditContext.
    ...
    protected override Component? Render() =>
        BsRow.Gutter(4)[
            ...
            BsCol.Md(6)[
                ...
                Form.Model(_model)[
                    BsMultiSelect.Bind(() => _model.Topics)
                        .Options(AllTopics)
                        .Id("fc-multiselect-bound")
                        .Placeholder("Choose topics…")
                ],
