...
//   • Bound — BsRadioGroup.Bind(() => model.X, options): two-way binds the scalar through the EditContext.
    ...
    protected override Component? Render() =>
        BsRow.Gutter(4)[
            BsCol.Md(6).Id("fc-radio-controlled")[
                ...
                // Controlled: no bind expression, so the type argument is written rather than inferred.
                BsRadioGroup
                    .Value(_controlled)
                    .Options(AllPlans)
