...
/// </summary>
public sealed class GestureBridgeDemo(IMediaStreams streams) : Component
{
                    ...
                    MediaCaptureTrigger(For: _preview, Video: true, FacingMode: "user",
                        ...
                        Template: g =>
                            Button(Type: "button", Class: "btn btn-outline-secondary btn-sm", Id: "camera-btn",
                                Data: g)["Start camera"]),
                    Button(Type: "button", Class: "btn btn-outline-secondary btn-sm", Id: "camera-stop-btn",
                        Disabled: _camera is null, OnClickAsync: StopCameraAsync)["Stop camera"],
