    ...
    protected override Component? Render() => Div(Class: "vstack gap-3")[
        BsStack(Gap: 3, Align: BsAlign.Start, WrapItems: true)[
            Figure(Class: "figure m-0")[
                ...
                Picture()[
                    ...
                    Img(Asset("rask-placeholder.svg"), "Rask logo", Width: 96, Height: 96, Class: "rounded border")
                ],
            ...
            Figure(Class: "figure m-0")[
                Iframe(Srcdoc: "<p style='font:13px sans-serif;margin:8px'>An inline iframe document.</p>",
                    Width: 180, Height: 96, Class: "border rounded"),
        ...
        BsStack(Gap: 3, Align: BsAlign.Start, WrapItems: true)[
            ...
            Figure(Class: "figure m-0")[
                ...
                Img(Asset("rask-placeholder.svg"), "Map", Width: 96, Height: 96, UseMap: "#regions", Class: "border rounded"),
