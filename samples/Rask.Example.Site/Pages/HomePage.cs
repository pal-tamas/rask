        ...
        Section.Class(SectionPad)[
            Div.Class(Wrap)[
                ...
                Div.Class("grid gap-4 sm:grid-cols-2 lg:grid-cols-3")[
                    ...
                    Feature(UiIconName.Puzzle, "Islands", "islands", "A ", Code[".tsx"], ", Vue, Svelte or Lit file as an ordinary Rask component, with its props declared in C# and its callbacks re-entering C#. A real Blazor component too — MudBlazor, an RCL — hosted server-rendered."),
