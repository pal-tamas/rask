...
public class DownloadPayloadBenchmarks
{
    ...
    private readonly ArrayBufferWriter<byte> _writer = new(initialCapacity: 8192);
    ...
    private int BuildBase64Payload(byte[] bytes)
    {
        ...
        var dl = new PendingDownload("f.bin", "application/octet-stream", Url: null, Bytes: bytes);
        LivePayload.BuildPayloadUtf8WithRoot(_writer, Html, "wasm", historyUrl: null, replace: false, cssText: null, auth: null, dl);
    ...
    private int BuildTokenPayload()
    {
        ...
        var dl = new PendingDownload("f.bin", "application/octet-stream", Url: null, Bytes: null,
            Token: "8c7eaa6c6c5d4d97a3b04ea5a3c2f1cd");
        LivePayload.BuildPayloadUtf8WithRoot(_writer, Html, "wasm", historyUrl: null, replace: false, cssText: null, auth: null, dl);
        return _writer.WrittenCount;
    }
}
