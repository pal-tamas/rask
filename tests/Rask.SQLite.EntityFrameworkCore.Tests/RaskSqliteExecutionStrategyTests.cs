...
public sealed class RaskSqliteExecutionStrategyTests : IDisposable
{
    ...
    public async Task Enabling_retry_turns_off_the_native_busy_handler()
    {
        var options = new DbContextOptionsBuilder<ProbeDbContext>()
            .UseRaskSqliteAt(ConnectionString, o => o.Retry.Enabled = true)
            .Options;
    ...
    {
        var options = new DbContextOptionsBuilder<ProbeDbContext>()
            .UseRaskSqliteAt(ConnectionString)
            .Options;
    ...
    {
        var options = new DbContextOptionsBuilder<ProbeDbContext>()
            .UseRaskSqliteAt(ConnectionString, o => { o.Retry.Enabled = true; o.Retry.Timeout = TimeSpan.FromSeconds(10); })
            .Options;
    ...
    {
        var options = new DbContextOptionsBuilder<ProbeDbContext>()
            .UseRaskSqliteAt(ConnectionString, o => { o.Retry.Enabled = true; o.Retry.Timeout = TimeSpan.FromMilliseconds(200); })
            .Options;
    ...
    public async Task A_long_lived_context_still_retries_a_later_contention()
    {
        ...
        var options = new DbContextOptionsBuilder<ProbeDbContext>()
            .UseRaskSqliteAt(ConnectionString, o => { o.Retry.Enabled = true; o.Retry.Timeout = TimeSpan.FromSeconds(2); })
            .Options;
