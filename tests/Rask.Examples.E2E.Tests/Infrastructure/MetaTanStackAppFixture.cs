...
/// <summary>
///     The TanStack Start meta framework sample: Kestrel on the public port, TanStack Start's own Node server
...
/// </remarks>
public sealed class MetaTanStackAppFixture : ExampleAppFixture
{
    protected override string ProjectRelativePath => "samples/Rask.Example.Meta.TanStack";
}
