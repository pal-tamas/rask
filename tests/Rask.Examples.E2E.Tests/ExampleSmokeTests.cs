...
// Non-forms showcase smoke tests. The forms / binding / validation surface lives in
// SharedSmokeTests so the same suite can run against the WasmAppHost-served standalone
// example too (no SPA fallback there). The tests below use Page.GotoAsync directly
