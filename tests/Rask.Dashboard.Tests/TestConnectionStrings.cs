...
/// <summary>
/// <c>AddRaskLogging</c> reads its connection string from <c>Rask:ConnectionStrings:Logs</c>. The log-page tests give
/// the harness its own throwaway store, so this registers exactly that one key as the container's configuration and
