...
public sealed class UiPaletteTests
{
    ...
    public void The_document_links_the_kits_stylesheet()
    {
        ...
        // App-root, not _content/{assembly}/. The showcase used to be a class library whose wwwroot was
        // served from its own static-web-asset prefix; one project means one wwwroot.
        Assert.Contains("/css/rask-ui.css", html, StringComparison.Ordinal);
