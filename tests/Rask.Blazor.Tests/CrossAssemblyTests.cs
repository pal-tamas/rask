...
public partial class CrossAssemblyTests : global::Rask.Core.RaskMarkup
{
    ...
    {
        var html = Page.Render(TickerIsland.Symbol("RASK").Price(12.5m), Services()).Html;
    ...
    public void EditorRequired_in_the_referenced_component_is_required_here()
    {
        ...
        var html = Page.Render(TickerIsland.Symbol("RASK").Tone("up"), Services()).Html;
    ...
    public void An_unset_optional_parameter_leaves_the_components_own_markup_alone()
    {
        ...
        var html = Page.Render(TickerIsland.Symbol("RASK"), Services()).Html;
    ...
    public void A_bound_input_is_wired_to_Rasks_VALUE_channel_not_its_DOM_event_channel()
    {
        ...
        var html = Page.Render(EditorIsland.Text("hello"), Services()).Html;
    ...
    public void A_hosted_components_text_and_attributes_are_HTML_ENCODED()
    {
        ...
        var page = Page.Render(EditorIsland.Text(Attack), Services());
        ...
        var quoted = Page.Render(EditorIsland.Text("\" onfocus=\"alert(1)"), Services());
    ...
    public void A_NESTED_island_generates_inside_its_container()
    {
        ...
        var html = Page.Render(NestedTicker.Symbol("RASK"), Services()).Html;
    ...
    public void A_javascript_URL_in_a_hosted_attribute_is_neutralised()
    {
        ...
        var ok = Page.Render(TickerIsland.Symbol("RASK").Url("/quotes/rask"), Services()).Html;
    ...
    public void A_renamed_parameter_actually_REACHES_the_hosted_component()
    {
        ...
        var html = Page.Render(RenamedIsland.Symbol("RASK").Annotation("halted"), Services()).Html;
    ...
    public void A_fragment_parameter_gets_no_chain_step()
    {
        ...
        Assert.Contains("RASK", Page.Render(TickerIsland.Symbol("RASK"), Services()).Html,
