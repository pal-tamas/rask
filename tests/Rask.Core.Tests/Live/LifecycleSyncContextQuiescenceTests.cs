...
/// <summary>
///     A component whose <c>OnMount</c> parks on a gate the test opens from another thread, then
...
/// <summary>
///     A component whose <c>OnMount</c> awaits with <c>ConfigureAwait(false)</c> and nothing else,
...
public sealed partial class ConfigureAwaitHookProbe : Component
{
    ...
    protected override async Task OnMount() => await Resume.Task.ConfigureAwait(false);
