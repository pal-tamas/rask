...
public class HotReloadClientContractTests
{
    ...
    {
        // src/Rask.Wasm/Browser/rask.wasm.js is generated by the build and COMMITTED. Editing the shared
        // module without rebuilding leaves it stale, which no other test would catch — the marker would
        // still be sitting there unsubstituted.
