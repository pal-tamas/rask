...
{
    [Fact]
    public void Unset_props_render_only_the_self_closing_tag() => Assert.Equal("<link />", Link.ToHtml());
    ...
    [Fact]
    public void Fetch_priority_and_blocking_emit_after_the_other_link_attributes() =>
        Assert.Equal(
