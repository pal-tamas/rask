...
{
    [Fact]
    public void Setting_every_prop_on_a_filter_emits_the_expected_attributes() =>
        Assert.Equal(
    ...
    [Fact]
    public void Setting_every_prop_on_a_fe_gaussian_blur_emits_the_expected_attributes() =>
        Assert.Equal(
    ...
    [Fact]
    public void Setting_every_prop_on_a_fe_offset_emits_the_expected_attributes() =>
        Assert.Equal(
            "<feOffset in=\"b\" dx=\"3\" dy=\"4\" result=\"o\"></feOffset>",
            FeOffset.In("b").Dx("3").Dy("4").Result("o").ToHtml());

    [Fact]
    public void Setting_every_prop_on_a_fe_blend_emits_the_expected_attributes() =>
        Assert.Equal(
            "<feBlend in=\"a\" in2=\"b\" mode=\"multiply\" result=\"r\"></feBlend>",
            FeBlend.In("a").In2("b").Mode("multiply").Result("r").ToHtml());

    [Fact]
    public void Setting_every_prop_on_a_fe_color_matrix_emits_the_expected_attributes() =>
        Assert.Equal(
    ...
    [Fact]
    public void Setting_every_prop_on_a_fe_composite_emits_the_expected_attributes() =>
        Assert.Equal(
    ...
    [Fact]
    public void Fe_merge_with_merge_node_children_nests_correctly() =>
        Assert.Equal(
    ...
    [Fact]
    public void Setting_every_prop_on_a_fe_flood_emits_the_expected_attributes() =>
        Assert.Equal(
            "<feFlood flood-color=\"#000\" flood-opacity=\"0.5\" result=\"r\"></feFlood>",
            FeFlood.FloodColor("#000").FloodOpacity("0.5").Result("r").ToHtml());

    [Fact]
    public void Setting_every_prop_on_a_fe_drop_shadow_emits_the_expected_attributes() =>
        Assert.Equal(
