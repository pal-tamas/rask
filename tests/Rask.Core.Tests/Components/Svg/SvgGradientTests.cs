...
{
    [Fact]
    public void Setting_every_LinearGradient_prop_emits_the_expected_attributes() =>
        Assert.Equal(
    ...
    [Fact]
    public void Setting_every_RadialGradient_prop_emits_the_expected_attributes() =>
        Assert.Equal(
    ...
    [Fact]
    public void Setting_every_Stop_prop_emits_the_expected_attributes() =>
        Assert.Equal(
            "<stop offset=\"50%\" stop-color=\"blue\" stop-opacity=\"0.5\"></stop>",
            Stop.Offset("50%").StopColor("blue").StopOpacity("0.5").ToHtml());

    [Fact]
    public void A_gradient_nests_its_stop_children() =>
        Assert.Equal(
    ...
    [Fact]
    public void Setting_every_Pattern_prop_emits_the_expected_attributes() =>
        Assert.Equal(
