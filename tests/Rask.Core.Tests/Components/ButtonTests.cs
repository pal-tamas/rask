...
public partial class ButtonTests : global::Rask.Core.RaskMarkup
{
    ...
    [Fact]
    public void Disabled_emits_a_bare_attribute()
    {
        Assert.Equal(
    ...
    [Fact]
    public void Not_disabled_emits_no_attribute_at_all()
    {
        Assert.Equal(
            "<button></button>",
    ...
    [Fact]
    public void Setting_the_type_emits_its_attribute()
    {
        Assert.Equal(
    ...
    [Fact]
    public void A_name_and_a_value_are_both_emitted_quoted()
    {
        Assert.Equal(
    ...
    [Fact]
    public void The_form_overrides_emit_every_attribute_the_spec_lists() =>
        Assert.Equal(
    ...
    [Fact]
    public void A_popover_target_pairs_with_the_global_popover_attribute() =>
    ...
    [Fact]
    public void The_boolean_attributes_emit_presence_only()
    {
    ...
    [Fact]
    public void Setting_every_prop_emits_the_inherited_attributes_before_the_button_s_own()
    {
        Assert.Equal(
    ...
    [Fact]
    public void The_accessibility_props_come_before_the_tag_specific_attributes()
    {
        Assert.Equal(
    ...
    [Fact]
    public void Constructor_params_array_renders_children_in_order()
    {
        Assert.Equal(
            "<button>a<b></button>",
    ...
    [Fact]
    public void Constructor_IEnumerable_overload_renders_children_in_order()
    {
    ...
    [Fact]
    public void The_form_overrides_come_after_the_button_s_own_attributes() =>
        Assert.Equal(
    ...
    [Fact]
    public void A_javascript_form_action_is_sanitised_away() =>
        Assert.DoesNotContain("javascript:", Button.FormAction("javascript:alert(1)").ToHtml(),
            StringComparison.OrdinalIgnoreCase);

    [Fact]
    public void A_popover_target_emits_both_halves() =>
        Assert.Equal(
    ...
    [Fact]
    public void A_command_emits_both_halves() =>
    ...
    [Fact]
    public void A_command_comes_after_the_popover_pair() =>
