...
public sealed partial class OrderedDispatchApp : Component
{
    ...
    protected override Component? HeadAssets => Markup.Title["ordered-dispatch"];
    protected override string? HtmlLang => null;

    protected override Component? Render() =>
    [
        Markup.P[$"Sequence={Sequence}"],
        Buttons()
    ];
    ...
    private Component Buttons()
    {
        ...
        {
            var captured = i;
            children.Add(Button.OnClick(() => RecordAsync(captured)).Key(captured)[$"#{captured}"]);
        }
