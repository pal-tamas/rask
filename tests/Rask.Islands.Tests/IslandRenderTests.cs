...
public sealed partial class Gauge : Component
{
    /// <summary>The needle position, 0..1.</summary>
    public double Value { get; set; }
}

// Renders real islands rather than asserting on generator output as text. What has to work is the
// whole seam: [Island] is discovered, the partial is generated, the host element serializes with the
// diff-boundary marker, and the props JSON is exactly what the front end will be typed against.
public partial class IslandRenderTests : global::Rask.Core.RaskMarkup
{
    [Fact]
    public void An_island_renders_a_host_element_carrying_the_diff_boundary()
    {
        ...
        Assert.StartsWith("<rask-island ", html, StringComparison.Ordinal);
    ...
    [Fact]
    public void An_explicit_module_and_runtime_are_used_as_declared()
    {
    ...
    public void An_island_renders_no_children_of_its_own()
    {
        ...
        Assert.EndsWith("></rask-island>", html, StringComparison.Ordinal);
    }
