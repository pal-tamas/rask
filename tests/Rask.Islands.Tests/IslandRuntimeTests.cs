...
// The browser half of the boundary, driven against the production rask-islands.js in node.
//
...
public sealed class IslandRuntimeTests
{
    private const string Fixture = "tests/Rask.Islands.Tests/IslandRuntimeFixture.mjs";
    private const string Runtime = "src/Rask.Islands/wwwroot/rask-islands.js";
