// Node-driven fixture for the island client runtime (src/Rask.External/wwwroot/rask-external.js).
//
...
if (!runtimePath) {
    console.error("usage: node ExternalRuntimeFixture.mjs <rask-external.js path>");
    process.exit(2);
}
...
const dir = mkdtempSync(join(tmpdir(), "rask-external-"));
const copy = join(dir, "rask-external.mjs");
