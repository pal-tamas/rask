...
// against.
public partial class TypeScriptRenderTests : global::Rask.Core.RaskMarkup
{
    [Fact]
    public void An_island_renders_a_host_element_carrying_the_diff_boundary()
    {
        ...
        Assert.StartsWith("<rask-ts ", html, StringComparison.Ordinal);
    ...
    public void An_island_renders_no_children_of_its_own()
    {
        ...
        Assert.EndsWith("></rask-ts>", html, StringComparison.Ordinal);
    }
