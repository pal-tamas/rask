...
// The browser half of the boundary, driven against the production rask-ts.js in node.
//
...
public sealed class TypeScriptRuntimeTests
{
    private const string Fixture = "tests/Rask.TypeScript.Tests/TypeScriptRuntimeFixture.mjs";
    private const string Runtime = "src/Rask.TypeScript/wwwroot/rask-ts.js";
