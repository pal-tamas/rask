...
public class NativeChromeInHtmlAnalyzerTests
{
    ...
    [Fact]
    public async Task HtmlInsideNativeScreen_ReportsRask046()
    {
        ...
        var diagnostics = await GetDiagnosticsAsync(src, id: "RASK046");
    ...
    [Fact]
    public async Task HtmlInsideANativeStack_ReportsRask046()
    {
        var src = """
                  using Rask.Core;
                  using static Rask.Core.Components.Generated;
        ...
        Assert.Equal("RASK046", Assert.Single(diagnostics).Id);
    }
