...
public partial class UiModalTests : global::Rask.Core.RaskMarkup
{
    ...
    public void Closing_is_reported_through_the_dialogs_own_toggle_on_the_modal_path()
    {
        ...
        Assert.Contains(
            "data-rask-on-toggle=",
            global::Rask.Testing.RaskTest.Render(Ui.Modal.Title("Delete order").Id("confirm").OnClose(() => { })).Html);
        Assert.DoesNotContain(
            "data-rask-on-toggle=",
            global::Rask.Testing.RaskTest.Render(Ui.Modal.Title("Delete order").Id("confirm")).Html);
    }
    ...
    public async Task A_dismissal_on_the_state_driven_path_raises_OnCancel_then_OnClose()
    {
        ...
        var page = global::Rask.Testing.RaskTest.Render(Ui.Modal.Title("Edit")
            .Open(true)
    ...
    {
        var cancelled = 0;
        var page = global::Rask.Testing.RaskTest.Render(Ui.Modal.Title("Edit").Id("edit").OnCancel(() => cancelled++));
    ...
    {
        var html = global::Rask.Testing.RaskTest.Render(Ui.Modal.Title("Edit").Id("edit")).Html;
