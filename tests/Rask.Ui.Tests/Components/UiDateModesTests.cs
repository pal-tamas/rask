...
public partial class UiDateModesTests : global::Rask.Core.RaskMarkup
{
    ...
    public async Task Binding_a_list_of_days_is_the_several_days_control_and_writes_the_list_back()
    {
        ...
        var page = RaskTest.Render(() => Ui.Calendar.Bind(() => model.DaysOff).Label("Days off").Month(March));
    ...
    {
        var model = new Holiday();
        var page = RaskTest.Render(() => Ui.Calendar.Bind(() => model.Stay).Label("Stay").Month(March));
    ...
    public async Task A_calendar_left_to_itself_pages_between_months()
    {
        ...
        var page = RaskTest.Render(() => Ui.Calendar.Value(Mar(14)).Label("Delivery date"));
    ...
    {
        var model = new Holiday();
        var page = RaskTest.Render(() => Ui.DatePicker.Bind(() => model.Arrival).Label("Arrival"));
