...
public partial class UiFieldsetTests : global::Rask.Core.RaskMarkup
{
    ...
    public void The_caption_is_the_legend()
    {
        ...
        var html = Ui.Fieldset.Text("Email")[Span["field"]].ToHtml();
    ...
    public void It_never_renders_a_title_element() =>
        Assert.DoesNotContain(
            "<title",
            Ui.Fieldset.Text("Email")[Span["field"]].ToHtml(),
    ...
    public void Help_text_is_rendered_when_given() =>
        Assert.Contains(
            "We never share it.",
            Ui.Fieldset.Text("Email").Help("We never share it.")[Span["field"]].ToHtml(),
            StringComparison.Ordinal);
    ...
    public void An_own_class_joins_the_daisyui_one() =>
        Assert.Contains(
            "fieldset w-full",
            Ui.Fieldset.Text("Email").Class("w-full")[Span["field"]].ToHtml(),
            StringComparison.Ordinal);
}
