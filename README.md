...
| `Rask.External` | [![Rask.External](https://img.shields.io/nuget/v/Rask.External.svg?label=%20)](https://www.nuget.org/packages/Rask.External) | A `.tsx` or Lit file as an ordinary Rask component, with props owned by C# |
