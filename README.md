...
| **[Browser APIs](docs/browser-apis.md)** · **[Mobile & PWA](docs/pwa.md)** · **[Native mobile](docs/native.md)** | The mobile & devices track: 49 typed Web-API wrappers, installable offline PWAs, and native iOS/Android apps. |
