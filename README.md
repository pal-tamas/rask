...
- **[Browser APIs](docs/browser-apis.md)** — 40 typed wrappers over Web APIs (storage, clipboard, geolocation, network, observers, media session, device sensors, crypto, IndexedDB, camera/mic, serial, share/push/badge/install…), shared or WASM-only.
