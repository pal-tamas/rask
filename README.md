...
- **[Browser APIs](docs/browser-apis.md)** — 41 typed wrappers over Web APIs (storage, clipboard, geolocation, network, observers, media session, device sensors, crypto, IndexedDB, camera/mic, serial, USB, share/push/badge/install…), shared or WASM-only.
